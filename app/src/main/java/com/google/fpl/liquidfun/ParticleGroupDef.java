...
public class ParticleGroupDef {
  ...
  public void setPolygonShapes(PolygonShape value) {
    liquidfunJNI.ParticleGroupDef_polygonShapes_set(swigCPtr, this, PolygonShape.getCPtr(value), value);
  }

  public PolygonShape getPolygonShapes() {
    long cPtr = liquidfunJNI.ParticleGroupDef_polygonShapes_get(swigCPtr, this);
    return (cPtr == 0) ? null : new PolygonShape(cPtr, false);
  }
  ...
  public void setPolygonShapesFromVertexList(java.nio.ByteBuffer inBuf, java.nio.ByteBuffer inBufshapeNums, int numShapes) {
    liquidfunJNI.ParticleGroupDef_setPolygonShapesFromVertexList(swigCPtr, this, inBuf, inBufshapeNums, numShapes);
  }

//debug
  public int getNums(int index) {
    return liquidfunJNI.ParticleGroupDef_getNums(swigCPtr, this, index);
  }
  public float getPointsOne(int index) {
    return liquidfunJNI.ParticleGroupDef_getPointsOne(swigCPtr, this, index);
  }
//debug
  ...
  public void setDummy() {
    liquidfunJNI.ParticleGroupDef_setDummy(swigCPtr, this);
  }
